...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			//cost menu
			if ($this->user->hasPermission('access', 'cost/cost')) {
				$data['menus'][] = array(
					'id'       => 'menu-cost',
					'icon'	   => 'fa-usd',
					'name'	   => $this->language->get('text_cost'),
					'href'     => $this->url->link('cost/cost', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			 }
			...
			if ($this->user->hasPermission('access', 'custom/description')) {
				$custom[] = array(
					'name'	   => $this->language->get('text_custom_description'),
					'href'     => $this->url->link('custom/description', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			 }
			 if ($this->user->hasPermission('access', 'custom/user')) {
				$custom[] = array(
					'name'	   => $this->language->get('text_custom_user'),
					'href'     => $this->url->link('custom/user', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			 }
			 if ($custom) {
			...
			// 	$custom[] = array(
			// 		'name'	   => $this->language->get('text_custom_user'),
			// 		'href'     => $this->url->link('custom/users ', 'user_token=' . $this->session->data['user_token'], true),
			// 		'children' => array()
			// 	);
			// }
